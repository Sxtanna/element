...
public record FluentServerImpl(@NotNull Server source, @NotNull ElementSystem system) implements FluentServer
{

    public FluentServerImpl(@NotNull final Server source)
    {
    ...
    @Override
    public @NotNull <E extends ServerEvent> EventBindingBuilder<E> on(@NotNull final Class<E> clazz)
    {
        return Events.on(clazz);
    }
